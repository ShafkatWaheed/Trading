...
SECTION_THEME = {
    ...
    "dark pool":            {"icon": "🌑", "color": "violet", "category": "Dark Pool Flow",       "max": 1},
    "government contracts": {"icon": "📜", "color": "blue",   "category": "Government Contracts",  "max": 1},
    "lobbying":             {"icon": "💰", "color": "amber",  "category": "Lobbying",             "max": 1},
    "corporate flights":    {"icon": "✈",  "color": "neutral","category": "Corporate Flights",    "max": 1},
